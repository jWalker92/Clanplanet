...
namespace Clanplanet.UWP.Implementation
{
    class SecureStore : ISecureStore
    {
        public void SaveCredentials(Login login)
        {
            if (!string.IsNullOrWhiteSpace(login.Username) && !string.IsNullOrWhiteSpace(login.Password))
            {
                ...
                account.Properties.Add("ClanId", string.IsNullOrEmpty(login.ClanID) ? "null" : login.ClanID);
        ...
        public string ClanId
        {
            ...
            {
                var account = AccountStore.Create().FindAccountsForService(App.AppName).FirstOrDefault();
                return (account != null) ? (account.Properties["ClanId"] == "null" ? null : account.Properties["ClanId"]) : null;
            }
        }
        ...
        public bool Reminder
        {
            ...
            {
                var account = AccountStore.Create().FindAccountsForService(App.AppName).FirstOrDefault();
                return (account != null) ? account.Properties["Reminder"].Equals("true") : false;
            }
        }
        ...
        public bool AutoRemind
        {
            ...
            {
                var account = AccountStore.Create().FindAccountsForService(App.AppName).FirstOrDefault();
                return (account != null) ? account.Properties["AutoRemind"].Equals("true") : false;
            }
        }
    ...
    public Login GetLogin()
        ...
        {
            var stores = AccountStore.Create().FindAccountsForService(App.AppName);
            return stores.Any() ? true : false;
        }
